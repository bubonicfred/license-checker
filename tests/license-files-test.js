var assert = require("assert"), licenseFiles = require("../lib/license-files");

describe("license files detector", function() {
  it("should export a function",
     function() { assert.equal(typeof licenseFiles, "function"); });

  it("no files", function() { assert.deepEqual(licenseFiles([]), []); });
